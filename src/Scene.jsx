...
Command: npx gltfjsx@6.2.4 public/models/scene.gltf
...
export function CarModel(props) {
  ...
  return (
    <group  {...props} dispose={null} position-y={3}>
      ...
      <mesh geometry={nodes.Brake_Caliper_RL_Brake_Caliper_0.geometry} material={materials.Brake_Caliper} position={[-159.931, 76.367, 270.737]} rotation={[-Math.PI / 2, -Math.PI / 2, 0]} scale={[106.859, 106.859, 108.79]} />
      <mesh geometry={nodes.Brake_Caliper_RR_Brake_Caliper_0.geometry} material={materials.Brake_Caliper} position={[-159.931, 76.367, 270.737]} rotation={[-Math.PI / 2, -Math.PI / 2, 0]} scale={[106.859, 106.859, 108.79]} />
      <mesh geometry={nodes.Brake_Caliper_FR_Brake_Caliper_0.geometry} material={materials.Brake_Caliper} position={[-159.931, 76.367, 270.737]} rotation={[-Math.PI / 2, -Math.PI / 2, 0]} scale={[106.859, 106.859, 108.79]} />
